...
function Item({ item }) {
   ...
   return (
      <div onClick={() => selectItem(item)} href='/detail' className="flex flex-col w-48 h-[22rem] bg-white border border-gray-200 shadow cursor-pointer">
         <div className="flex h-40 m-2.5 bg-[#C4C4C4]" href='#'>
