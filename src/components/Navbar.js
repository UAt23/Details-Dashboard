...
function Navbar(props) {
   return (
      <nav class="bg-[#2A59FE] border-gray-200 dark:bg-gray-900">
         <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto  p-2">
            <a href="https://www.eteration.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
               <h2 className='text-2xl text-white font-extrabold'>Eteration</h2>
            </a>
            <div class="flex md:order-1 w-96">
               ...
               <div class="relative hidden md:block w-full">
                  ...
                  <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-none bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
                  </input>
               </div>
            ...
            <div class="flex items-center gap-3 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
               <div class='flex items-center gap-1'>
                  ...
                  <span class="block text-sm text-white">12039801238012380</span>
               </div>
               <div class='flex items-center gap-1'>
                  <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <span class="block text-sm text-white">Alp</span>
               </div>
