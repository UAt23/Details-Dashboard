...
function Filters() {
   const { models, brands } = useContext(ItemsContext);
      ...
      return (
         <li key={index} className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
            <div className="flex items-center ps-3">
               ...
               <label for="vue-checkbox" className="w-full py-2 ms-2 text-sm font-normal text-gray-900 dark:text-gray-300">{model}</label>
            </div>
         </li>
      )
   });
      ...
      return (
         <li key={index} className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
            <div className="flex items-center ps-3 ">
               ...
               <label for="laravel-checkbox" className="w-full py-2 ms-2 text-sm font-normal text-gray-900 dark:text-gray-300">{brand}</label>
            </div>
         </li>
      )
   });
   ...
   return (
      <div className=''>
         <div className='flex flex-col gap-1 h-36 pb-48'>
            <h3 className="font-400 text-[#333333b3] text-xs">Sort by</h3>
            <ul className="w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25);] dark:bg-gray-700 dark:border-gray-600 dark:text-white">
               <li className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
                  <div className="flex items-center ps-3">
                     ...
                     <label for="list-radio-license" className="w-full py-2 ms-2 text-sm  font-normal text-gray-900 dark:text-gray-300">Old to new </label>
                  </div>
               </li>
               <li className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
                  <div className="flex items-center ps-3">
                     ...
                     <label for="list-radio-id" className="w-full py-2 ms-2 text-sm  font-normal text-gray-900 dark:text-gray-300">New to old</label>
                  </div>
               </li>
               <li className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
                  <div className="flex items-center ps-3">
                     ...
                     <label for="list-radio-military" className="w-full py-2 ms-2 text-sm  font-normal text-gray-900 dark:text-gray-300">Price hight to low</label>
                  </div>
               </li>
               <li className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
                  <div className="flex items-center ps-3">
                     ...
                     <label for="list-radio-passport" className="w-full py-2 ms-2 text-sm  font-normal text-gray-900 dark:text-gray-300">Price low to High</label>
                  </div>
               </li>
            </ul>
         </div>
