      ...
      return (
         <li key={index} className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
            <div className="flex items-center ps-3">
               ...
               <label for="vue-checkbox" className="w-full py-2 ms-2 text-sm font-normal text-gray-900">{model.label}</label>
            </div>
         </li>
      )
   });
      ...
      return (
         <li key={index} className="w-full border-gray-200 rounded-t-lg dark:border-gray-600">
            <div className="flex items-center ps-3 ">
               ...
               <label for="laravel-checkbox" className="w-full py-2 ms-2 text-sm font-normal text-gray-900">{brand.label}</label>
            </div>
         </li>
      )
   });
