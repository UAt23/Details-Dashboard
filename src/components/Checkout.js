...
function Checkout() {
   ...
   return (
      <div>
         <div className='flex flex-col gap-1 h-48 mb-6'>
            <h3 className="font-400 text-[#333333b3] text-xs">Cart</h3>
            <ul className="w-56 h-48 overflow-auto flex flex-col text-sm font-medium text-gray-900 bg-white border border-gray-200 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
               {renderedCartItems.length ? renderedCartItems : noContent}
            </ul>
         </div>
         <div className='flex flex-col gap-1 h-auto w-56 p-2.5 text-sm font-medium text-gray-900 bg-white border border-gray-200 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]'>
